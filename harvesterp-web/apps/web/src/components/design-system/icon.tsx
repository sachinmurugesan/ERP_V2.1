...
/**
 * Icon — ported from apps/ui-gallery. Inline SVG icon set for HarvestERP.
...
export type IconName =
  | "home" | "dashboard" | "finance" | "sales" | "crm" | "inventory"
  | "procurement" | "reports" | "settings" | "search" | "bell" | "plus"
  | "filter" | "download" | "upload" | "chevronR" | "chevronL" | "chevronD"
  | "chevronU" | "arrowUp" | "arrowDown" | "arrowRight" | "check" | "close"
  | "more" | "moreV" | "calendar" | "clock" | "user" | "logout" | "moon"
  | "sun" | "expand" | "box" | "truck" | "invoice" | "credit" | "globe"
  | "shield" | "tag" | "warning" | "flame" | "star" | "sparkle" | "zap"
  | "refresh" | "grid" | "list" | "help";
...
const iconPaths: Record<IconName, React.ReactElement> = {
  ...
  settings: <><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09a1.65 1.65 0 0 0 1.51-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33h.01A1.65 1.65 0 0 0 10 3.09V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82v.01a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></>,
