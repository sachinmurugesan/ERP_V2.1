...
/**
 * Table primitives — semantic HTML wrappers styled to match the design
 * system. Ported from apps/ui-gallery's shadcn-standard table.
 *
 * The outer <div> gives the <table> a horizontal scroll container so
 * 10-column tables (factory ledger) work on narrower viewports without
